...
@implementation HBButtonAddView
...
- (void)addButtonAction:(UIButton *)sender {
    ...
    if ([sender.currentImage isEqual:[UIImage imageNamed:@"shanchushuxing"]]) { // 删除
